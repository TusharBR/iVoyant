...
function App() {
  ...
  return (
    <>
      ...
      <footer style={{padding:"10px",textAlign:"center",backgroundColor:"lightblue",color:"red",fontSize:"80px"}}>Items added in cart are : {before.length} - Total amount : {totalamt.toFixed(2)}Rs</footer>
    </>
  )
}
