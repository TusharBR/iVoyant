...
var challenge = '45 days of internship';
...
var senc = '30 Days Of JavaScript';
...
var companiesnames = 'Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon';
...
var newString = senc.replace('JavaScript', 'Python');
...
var stringWithSpaces = ' 30 Days Of JavaScript ';
...
var randomnum2 = Math.floor(Math.random() * 50) + 50;
...
var str2 = 'JavaScript';
var randomindx = Math.floor(Math.random() * str2.length);
console.log(str2[randomindx]); // r
//  11: Use console.log() and escape characters to print the following pattern
var result = "";
for (var fi = 1; fi < 5 + 1; fi++) {
    result += fi + " ";
    for (var i = 0; i < 5 - 1; i++) {
...
var slicedPhrase = 'You cannot end a sentence with because because because is a conjunction';
var fr = slicedPhrase.substring(slicedPhrase.indexOf('because'), slicedPhrase.lastIndexOf('because') + "because".length);
